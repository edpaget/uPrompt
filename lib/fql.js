...
(function() {
  ...
  Fql.Number = (function(_super) {
    ...
    function Number(num) {
      ...
      this.reciprocate = __bind(this.reciprocate, this);
    ...
    Number.prototype.reciprocate = function() {
      return 1 / this.num;
    };
    ...
    Number.prototype.log = function(_arg) {
      ...
      num = _arg.num;
      return Math.log(this.num) / (num ? Math.log(num) : 1);
    };
  ...
  Fql.CFunc = (function(_super) {
    ...
    CFunc.prototype.reciprocate = function() {
      var _this = this;
  ...
  Fql.Field = (function(_super) {
    ...
    Field.prototype.reciprocate = function() {
      var _this = this;
  ...
  Fql.Subtract = (function(_super) {
    ...
    Subtract.prototype["eval"] = function() {
      return this.exp1["eval"]().add(new Negate(this.exp2)["eval"]());
    };
  ...
  Fql.Reciprocate = (function(_super) {
    __extends(Reciprocate, _super);

    function Reciprocate(exp) {
      this.exp = exp;
      this["eval"] = __bind(this["eval"], this);
    }

    Reciprocate.prototype["eval"] = function() {
      return this.exp["eval"]().reciprocate();
    };
  ...
  Fql.Divide = (function(_super) {
    ...
    Divide.prototype["eval"] = function() {
      return this.exp1["eval"]().muliply(new Reciprocate(this.exp2)["eval"]());
    };
